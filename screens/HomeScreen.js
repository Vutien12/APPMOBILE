    ...
    <View style={styles.container}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.scrollContainer}>
        <View style={styles.imageContainer}>
          <Image source={require('../images/IvoryCoast.jpg')} style={styles.image} />
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.scrollContainer}>
        <View style={styles.imageContainer}>
          <Image source={require('../images/Hedengolf.jpg')} style={styles.image} />
        ...
        <View style={styles.imageContainer}>
          <Image source={require('../images/SanFrancisco.jpg')} style={styles.image} />
          <Text style={styles.imageText}>San Francisco</Text>
        </View>
        <View style={styles.imageContainer}>
          <Image source={require('../images/VietNam.jpg')} style={styles.image} />
