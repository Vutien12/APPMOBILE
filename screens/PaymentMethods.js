...
const Muiten = require('../assets/Vector1.png');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cardContainer}>
        ...
        {/* Ảnh ở góc trái */}
        <Image source={require('../assets/Rectangle3.png')} style={styles.leftImage} />
        {/* Ảnh ở góc phải */}
        <Image source={require('../assets/visa-pay-logo.png')} style={styles.rightImage} />
        {/* Ảnh nằm đè lên ảnh góc trái 1 */}
        <Image source={require('../assets/Vector2.png')} style={styles.overlayImage1} />
        {/* Ảnh nằm đè lên ảnh góc trái 2 */}
        <Image source={require('../assets/Vector2.1.png')} style={styles.overlayImage2} />
